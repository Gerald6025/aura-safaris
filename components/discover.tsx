...
//         <h1 className="w-full max-w-4xl px-4 text-center font-bold leading-tight text-3xl sm:text-4xl md:text-5xl lg:text-6xl">
//           Featured Experiences
//         </h1>
//         <p className="w-full max-w-md px-4 text-center text-[14px] sm:text-[16px] text-black">
//           {" "}
//           Choose from our curated selection of unforgettable safari adventures
//         </p>
...
//             hoverSrc:
//               "https://res.cloudinary.com/dvqhcm07a/image/upload/v1762260483/15e26f6f2c18254d07d53d876439e7281ceca456_uo6vsd.png",
//             title: "Wildlife Safaris",
//             description:
//               "Experience breathtaking game drives through Hwange Chobe and Zambezi National Parks.",
//           },
//           {
//             src: "https://res.cloudinary.com/dvqhcm07a/image/upload/v1762260485/1dd5a89022f54842e3d701e5c788d31af5f0142b_zemmzy.png",
//             hoverSrc:
//               "https://res.cloudinary.com/dvqhcm07a/image/upload/v1762260825/9d29da193898b4e99e4e13bb85c99c4fe52489eb_ve6ups.png",
//             title: "Victoria Falls Tours",
//             description:
//               "Explore the majestic Victoria Falls with guided tours, helicopter flights, and sunset cruises.",
//           },
//           {
//             src: "https://res.cloudinary.com/dvqhcm07a/image/upload/v1762260484/ebaa1f7eeaaf73d0174528811c13f2b6e23178dc_wmchcq.png",
//             hoverSrc:
//               "https://res.cloudinary.com/dvqhcm07a/image/upload/v1762260484/792dfad461b75e89a2b3a10f6fd3c4dbc8b38a07_pbt7eu.png",
//             title: "Adventure Activities",
//             description:
//               "Thrilling experiences including quad biking, white-water rafting, bungee jumping, and more.",
//           },
//           {
...
//             description:
//               "Premium safari experiences with private tours, honeymoon packages, and exclusive lodge stays.",
//           },
//         ].map((card, idx) => (
...
//             >
//               <span className="transform transition-transform duration-500 ease-out group-hover:translate-y-1">
//                 {card.title}
//               </span>
//               <svg
...
const Discover = () => {
  return (
    <div className="w-full h-auto text-black bg-white">
      <div className="w-full h-[400px] flex flex-col pt-20 items-center gap-1">
        <p className="text-[16px]">Discover Our World</p>
        <h1 className="w-full max-w-4xl px-4 text-center font-bold leading-tight text-3xl sm:text-4xl md:text-5xl lg:text-6xl">
          Featured Experiences
        </h1>
        <p className="w-full max-w-md px-4 text-center text-[14px] sm:text-[16px]">
          Choose from our curated selection of unforgettable safari adventures
        </p>
        <div className="w-[200px] h-0.5 bg-[#cc9933] mt-5" />
      </div>

      <div className="px-12 gap-5 mx-auto grid md:grid-cols-4 -mt-20">
        {[
          {
            src: "https://res.cloudinary.com/dvqhcm07a/image/upload/v1762260482/f4cdd9a4fb0f6f53401b6acc25b2400b35201a23_xn4aot.jpg",
            title: "Wildlife Safaris",
          ...
          <div key={idx} className="flex flex-col relative">
            <div className="relative rounded-lg h-[330px] overflow-hidden">
              <Image
                src={card.src}
                alt={card.title}
                width={300}
            ...
            <div className="absolute left-1/2 bottom-[-10] -translate-x-1/2 translate-y-1/2">
              <div className="bg-white backdrop-blur-sm rounded-xl shadow-2xl ring-1 ring-black/5 p-4 w-[260px] text-center">
                <h3 className="text-[18px] font-semibold text-gray-900">
                  {card.title}
                </h3>
                <p className="mt-2 text-xs text-black">{card.description}</p>
                <Link
                  href={`/book?activity=${encodeURIComponent(card.title)}`}
                  className="mt-3 inline-flex items-center justify-center rounded-md bg-[#cc9933] px-3 py-1.5 text-xs font-semibold text-white hover:bg-[#b3832b] transition-colors"
                >
                  Book this Activity
                </Link>
              </div>
