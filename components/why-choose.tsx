  ...
  return (
    <section className="w-full bg-white mt-10  h-auto">
      <div className="mx-auto max-w-6xl px-6 py-20">
        ...
        <div className="mt-14 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 md:gap-70 gap-10 px-4 justify-items-center">
          {features.map((item, idx) => (
            <div
              key={idx}
              className="group cursor-pointer rounded-xl border border-gray-200 flex items-center justify-center flex-col bg-white p-6 w-[300px] h-[300px] shadow-[0_6px_0_rgba(0,0,0,0.2)] hover:shadow-[0_10px_10px_rgba(0,0,0,0.25)] transition-shadow"
            >
